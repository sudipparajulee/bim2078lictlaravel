...
@section('content')
    ...
    <div class="text-right my-5">
        <a href="{{route('categories.create')}}" class="bg-indigo-800 text-white  py-3 px-5 rounded font-bold">Add Category</a>
    </div>
        ...
        <tbody>
            ...
            <tr class="text-center">
                ...
                <td class="border p-2">
                    ...
                    <a href="{{route('categories.destroy',$category->id)}}" class="bg-red-500 text-white px-3 py-1.5 rounded-lg" onclick="return confirm('Are you sure to delete?')">Delete</a>
                </td>
            </tr>
            @endforeach
        </tbody>
