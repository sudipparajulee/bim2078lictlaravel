...
<div class="text-right my-5">
    <a href="{{route('products.create')}}" class="bg-indigo-800 text-white  py-3 px-5 rounded font-bold">Add Product</a>
</div>
...
<table class="mt-5 w-full">
    <thead>
        <tr>
            ...
            <th class="border p-2 bg-gray-200">Brand</th>
    ...
    <tbody>
        ...
        <tr class="text-center">
            ...
            <td class="border p-2">
                <a href="{{route('products.edit',$product->id)}}" class="bg-blue-500 text-white px-3 py-1.5 rounded-lg">Edit</a>
                <a href="{{route('products.destroy',$product->id)}}" class="bg-red-500 text-white px-3 py-1.5 rounded-lg" onclick="return confirm('Are you sure to delete?')">Delete</a>
            </td>
        </tr>
        @endforeach
    </tbody>
